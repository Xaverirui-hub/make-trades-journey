...
function makeEl(){ return { setAttribute(){}, appendChild(){}, style:{}, textContent:'', innerHTML:'' }; }
const __cards=[];
global.document = {
  getElementById(id){
    if(id==='examBox') return { appendChild(c){__cards.push(c);} };
    if(id==='examResult') return { innerHTML:'', scrollIntoView(){} };
    if(id==='examSubmit') return { style:{} };
    return makeEl();
  },
